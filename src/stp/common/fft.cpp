...
arma::Mat<cx_real_t> fft_fftw(arma::Mat<cx_real_t>& input, bool inverse, fft_routine r_fft, const std::string& wisdom_filename)
{
    arma::Mat<cx_real_t> output(arma::size(input));
...
arma::Mat<cx_real_t> fft_fftw_r2c(arma::Mat<real_t>& input, fft_routine r_fft, const std::string& wisdom_filename)
{
