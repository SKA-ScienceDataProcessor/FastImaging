...
int main(int argc, char** argv)
{
    ...
    load_npz_simdata(_fileArg.getValue(), input_uvw, input_model, input_vis);
    ...
    // Runs pipeline
    stp::source_find_image sfimage = run_pipeline(input_uvw, input_model, input_vis, cfg.image_size, cfg.cell_size, cfg.kernel_support, cfg.kernel_exact, cfg.oversampling, cfg.detection_n_sigma, cfg.analysis_n_sigma);
