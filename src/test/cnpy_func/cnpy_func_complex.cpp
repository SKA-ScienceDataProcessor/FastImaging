...
const char* COMPLEX_1D_PATH("../data/cnpy_test/complex_1d.npy");
const char* COMPLEX_2D_PATH("../data/cnpy_test/complex_2d.npy");
...
TEST(CnpyLoadComplex, complex1d)
{
    ...
    cnpy::NpyArray complex1d_array = cnpy::npy_load(location.append(COMPLEX_1D_PATH));
    arma::cx_mat complex1d = load_npy_array(&complex1d_array);
...
TEST(CnpyLoadComplex, complex2d)
{
    ...
    cnpy::NpyArray complex2d_array = cnpy::npy_load(location.append(COMPLEX_2D_PATH));
    arma::cx_mat complex2d = load_npy_array(&complex2d_array);
