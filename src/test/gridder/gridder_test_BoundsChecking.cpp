...
TEST(GridderBoundsChecking, vis_grid)
{
    ...
    GridderOutput grid = convolve_to_grid<true>(TopHat(half_base_width), support, image_size, bad_uv, vis, vis_weights, kernel_exact, oversampling);
    ...
    GridderOutput good_grid = convolve_to_grid<true>(TopHat(half_base_width), support, image_size, good_uv, vis, vis_weights, kernel_exact, oversampling);
    ...
    GridderOutput mixed_grid = convolve_to_grid<true>(TopHat(half_base_width), support, image_size, mixed_uv, vis, vis_weights, kernel_exact, oversampling);
