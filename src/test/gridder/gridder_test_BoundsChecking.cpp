...
TEST(GridderBoundsChecking, vis_grid)
{
    ...
    arma::Mat<cx_real_t>& sampling_grid = std::get<sampling_grid_index>(grid);
    ...
    arma::Mat<cx_real_t>& good_sampling_grid = std::get<sampling_grid_index>(good_grid);
    ...
    arma::Mat<cx_real_t>& mixed_sampling_grid = std::get<sampling_grid_index>(mixed_grid);
