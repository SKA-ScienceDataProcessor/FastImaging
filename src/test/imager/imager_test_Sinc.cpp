...
public:
        ...
        : ImagerHandler(typeConvolution, typeTest)
    {
        ...
        ImagerPars imgpars(image_size, cell_size, padding_factor, stp::KernelFunction::Sinc, support, kernel_exact, oversampling, gen_beam, gridding_correction, analytic_gcf);
        std::pair<arma::Mat<real_t>, arma::Mat<real_t>> orig_result = image_visibilities(Sinc(threshold, width_normalization), vis, vis_weights, uvw_lambda, imgpars);
