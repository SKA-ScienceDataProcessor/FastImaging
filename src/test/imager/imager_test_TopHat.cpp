...
public:
        ...
        : ImagerHandler(typeConvolution, typeTest)
    {
        ...
        std::pair<arma::Mat<cx_real_t>, arma::Mat<cx_real_t> > orig_result = image_visibilities(TopHat(half_base_width), vis, uvw_lambda, image_size, cell_size, support, kernel_exact, oversampling);
