...
public:
        ...
        : ImagerHandler(typeConvolution, typeTest)
    {
        ...
        std::pair<arma::Mat<real_t>, arma::Mat<real_t>> orig_result = image_visibilities(TopHat(half_base_width), vis, vis_weights, uvw_lambda, image_size, cell_size, support, kernel_exact, oversampling, gen_beam);
