...
public:
        ...
        : ImagerHandler(typeConvolution, typeTest)
    {
        ...
        result = image_visibilities(GaussianSinc(width_normalization_gaussian, width_normalization_sinc, trunc), vis, uvw_lambda, image_size, cell_size, support, oversampling);
    }
};
