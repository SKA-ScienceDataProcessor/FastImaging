...
*
*   @return Armadillo complex arma::mat with npy values
*/
template <typename data>
arma::cx_mat loadComplexNpyArray(cnpy::NpyArray* npy)
{ 
...
*/
arma::mat loadNpyArray(cnpy::NpyArray* npy)
{ 
     _logger -> debug("Starting loadNpyArray function");
    ...
    //Creates the armadillo matrices
    _logger -> debug("Creating armadillo matrices");
    arma::mat dataMat( (double*) arr, npy_size, 1);
