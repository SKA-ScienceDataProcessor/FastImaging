...
$ ./reduce fastimg_oversampling_config.json simdata_nstep10.npz -d -l 
```
...
```sh
$ cd build-directory/reduce
$ ./run_imager fastimg_oversampling_config.json simdata_nstep10.npz -d -l
```
...
```sh
$ cd build-directory/reduce
$ ./run_sourcefind fastimg_oversampling_config.json dirty_image.npz -l
```
...
$ cd path/to/build/directory
$ cd reduce
$ valgrind --tool=callgrind --separate-threads=yes ./reduce fastimg_oversampling_config.json simdata_nstep10.npz -d -l
